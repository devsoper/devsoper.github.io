...
**Working group &#x007C; Implementing Data Evaluation in Academia (IDEA).** Sponsored by [Make Data Count](https://makedatacount.org/) and [HELIOS Open](https://www.heliosopen.org/), the IDEA working group is developing resources to advance efforts to recognize and reward data publications and other data-related research accomplishments at academic institutions. The group plans to publish a maturity model, implementation guidelines, and case studies by the end of 2025. [More about the working group here](https://makedatacount.org/read-our-blog/implementing-data-evaluation-in-academia-working-group/). [Outputs of the working group available here](https://makedatacount.org/explore-resources/institutions/).
